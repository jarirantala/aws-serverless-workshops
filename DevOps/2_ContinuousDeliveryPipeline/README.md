...
1. In the left nav, click on `awscodestar-uni-api-lambda`. <b>NOTE by Jari: my API was named "awscodestar-uni-api-infrastructure-T5FLU8QAJ9F3" where T5FLU8QAJ9F3 is also in CloudFormation stack name.</b>
